...
public:
  ...
  icons() {
    ...
    LoadTexToSprite(textures.BlackKing, sprites.BlackKing,
                    "png/BK.png");
    LoadTexToSprite(textures.BlacksTurn, sprites.BlacksTurn,"png/BP.png");
    LoadTexToSprite(textures.WhitesTurn, sprites.WhitesTurn,"png/WP.png");
    PopulateMap();
  }
...
public:
  ...
  Display() : window(sf::VideoMode(800, 900), "Chess") {
